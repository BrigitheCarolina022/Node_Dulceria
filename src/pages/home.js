                                    ...
                                    <div className="col-lg-3 col-6">
                                        <div className="card card-primary card-outline">
                                            <div className="card-body box-profile">
                                                ...
                                                <h3 className="profile-username text-center">Arequipe de café </h3>
                                    ...
                                    <div className="col-lg-3 col-6">
                                        <div className="card card-primary card-outline">
                                            <div className="card-body box-profile">
                                                ...
                                                <h3 className="profile-username text-center">Chocorramo x12</h3>
                                                <p className="text-muted text-center">$8,000</p>
                                                <Link to={"/pedidos"} className="btn btn-primary btn-block"><b>Comprar</b></Link>
                                            </div>
                                        </div>
                                    ...
                                    <div className="col-lg-3 col-6">
                                        <div className="card card-primary card-outline">
                                            <div className="card-body box-profile">
                                                ...
                                                <h3 className="profile-username text-center">Barra Chocorramo Frutos Rojos x12</h3>
                                                <p className="text-muted text-center">$8,000</p>
                                                <Link to={"/pedidos"} className="btn btn-primary btn-block"><b>Comprar</b></Link>
                                            </div>
                                        </div>
